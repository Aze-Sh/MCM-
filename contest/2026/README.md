...
已选择 **B 题：无线电干扰源的快速自动定位与清除**。先读 [B题任务分解](B题任务分解.md) 和 [模拟器接入说明](模拟器接入说明.md)，原始题面在 `data/raw/B题.pdf`，附件 1、附件 2 已归档到 `data/raw/B题附件/`。问题 3、4 已各完成三轮官方演练，六轮累计清除 82/82；正式测试尚未启动。
