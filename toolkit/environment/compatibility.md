...
| B 题单元测试 | 通过 | `python -m pytest contest/2026/tests -q`：**40 passed**。 |
...
| B 题论文 XeLaTeX | 通过 | 双遍编译为 A4、18 页，交叉引用已解析；18 页全部渲染检查，并对新增图表页作 180 dpi 复核，无裁切、重叠或字体缺失。 |
| AI 详情 XeLaTeX | 通过 | 8 条实际记录编译为 5 页工作稿并逐页渲染；最终人工复核项保持未勾选。 |
