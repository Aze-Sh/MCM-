...
def main():
    parser = argparse.ArgumentParser(description="B题干扰源搜索与清除")
    ...
    parser.add_argument("--extra-actions", type=int, default=640, dest="dzys")
    ...
    print(f"本地记录：{mulu}")
    return 0 if zt["completed"] and zt["exit_confirmed"] else 2
